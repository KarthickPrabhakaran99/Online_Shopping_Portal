...
int currentProductId =   Integer.parseInt( request.getParameter("id"));
 
 String productName = productName(currentProductId);
 float productPrice = productData(productName(currentProductId), "productPrice");
 int productQuantity = productData(productName(currentProductId), "productQuantity");
 ...
 <div class="check-out container-fluid shadow">
         ...
         <ul class="list-group mb-3 sticky-top">
                <li class="list-group-item d-flex justify-content-between lh-condensed">
                    <div>
                        ...
                        <small class="text-muted">Quantity: <%=productQuantity %></small>
                    </div>
  ...
  <tr>
    ...
    <td bgcolor="white" class="text-lowercase"> <%=email %> </td>
   
      
  </tr>
    <tr>
     <form class="needs-validation"  method="post" action="buyOrderConfirmation.jsp?ProductId=<%=currentProductId %>&AddressCheck=<%=addressCheck %>">
...
<div class=" text-uppercase checkout-total-text" align="right"> Total(INR): Rs.<%=productPrice %> </div>
</div>
