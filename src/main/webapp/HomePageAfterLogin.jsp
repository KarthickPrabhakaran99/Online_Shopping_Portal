...
<body class="homepage-background-img ">
...
%>
	...
	<section>
	<div class="homepage-text text-uppercase " align="center">All Laptops available <span class="text-danger homepage-text-background">here</span> </div>
	<a href="index.jsp"><button type="button" class="btn btn-warning text-uppercase shop-now-button" align="center">SHOP NOW</button></a>
